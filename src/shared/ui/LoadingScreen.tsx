    ...
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-surface-raised">
      ...
      <div className="relative z-10 flex flex-col items-center gap-8">
        <div className="relative flex h-28 w-28 items-center justify-center">
          ...
          <motion.div className="h-12 w-12 rounded-2xl bg-gradient-to-br from-accent to-accent-soft shadow-[0_0_28px_rgba(124,110,245,0.65)]" animate={{ scale: [1, 1.12, 1], opacity: [0.85, 1, 0.85] }} transition={{ repeat: Infinity, duration: 1.6, ease: "easeInOut" }} />
          <motion.div className="absolute inset-0" animate={{ rotate: 360 }} transition={{ repeat: Infinity, duration: 3, ease: "linear" }}>
            <span className="absolute left-1/2 top-0 h-2 w-2 -translate-x-1/2 rounded-full bg-accent-soft shadow-[0_0_8px_rgba(167,139,250,0.8)]" />
            <span className="absolute bottom-0 left-1/2 h-1.5 w-1.5 -translate-x-1/2 rounded-full bg-accent shadow-[0_0_6px_rgba(124,110,245,0.7)]" />
          </motion.div>
        </div>
